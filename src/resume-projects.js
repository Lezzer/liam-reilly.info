        ...
        return (
            <div className={css.projects}>
                ...
                <ul>
                    ...
                    <li>Secure Document Upload:<span>I built an entirely new document upload component for our website, that enabled customers to safely upload sensitive documents such as photo ids, finance agreements and other documents.   I decided to build this using React/Redux which others on our team were not experienced with, but was used elsewhere on the website by other teams.  First I built a proof of concept, then took the team through it. I then paired with other team members, one by one and taught them React/Redux.  Before long, the team was working independently and extending the component to work for all the required different document types. </span></li>
