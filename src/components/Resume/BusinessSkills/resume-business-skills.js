        ...
        return (
            <div className={css.business_skills}>
                ...
                <ul>
                    ...
                    <li>Remote Working: <span>Seasoned remote worker.  Have worked as Principal Software Engineer as part of a remote team and also completed many personal/side contract jobs 100% remote.</span></li>
