        ...
        return (
            <div className={css.projects}>
                ...
                <ul id={'ditto'}>
                    ...
                    <li>Sales Import:<span>The first major project was to completely overhaul the internal sales import process.  As principal engineer I analysed the existing system, and built a new system on top of the AWS Infrastructure we put in place.  The new system validated, staged and processed data using AWS Lambda functions in minutes and published sales data to Elasticsearch.  The original system would take hours to process the same data, and was massively prone to errors.</span></li>
