        ...
        return (
            <div className={css.business_skills}>
                ...
                <ul>
                    ...
                    <li>Team Working: <span>Positively work with others, much experience using pair/mob programming approaches.  Easily build and maintain relationships to ensure the success of the team.  Experience of managing expectations and deliverables across teams in various departments.</span></li>
